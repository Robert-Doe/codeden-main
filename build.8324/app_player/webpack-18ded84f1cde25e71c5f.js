!function () {
   // "use strict";
    ...
    function r(t) {
        ...
        var i = e[t] = {id: t, loaded: !1, exports: {}}, u = !0;
        try {
        ...
        r.O = function (e, t, o, i) {
            if (!t) {
                ...
                for (a = 0; a < n.length; a++) {
                    ...
                    for (var f = !0, l = 0; l < t.length; l++) (!1 & i || u >= i) && Object.keys(r.O).every((function (n) {
                        return r.O[n](t[l])
    ...
    }, r.p = "//s2.pluralsight.com/course-player/_next/", function () {
        var n = {272: 0};
        r.O.j = function (e) {
            return 0 === n[e]
        };
        var e = function (e, t) {
            var o, i, u = t[0], f = t[1], l = t[2], c = 0;
            ...
            for (e && e(t); c < u.length; c++) i = u[c], r.o(n, i) && n[i] && n[i][0](), n[u[c]] = 0;
            return r.O(a)
